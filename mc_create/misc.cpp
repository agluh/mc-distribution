...
void processData(const QString &pdfFile, const QString &outputFileName, const QString &link, const QString &watermark, const QString &comments) {
	...
	std::string str = std::string(outputFileName.toLocal8Bit().constData());
